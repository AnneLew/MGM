...
data.table::fwrite(sens_local, file = paste0("./sensitivity/localsensitivity_2mdepth_alpseeschongau_all_corrMort.csv"))
...
senslocal05m<-data.table::fread(file = "./sensitivity/localsensitivity_1stdepth_alpseeschongau_all_corrMort.csv")
senslocal05m$depth<-0.5
senslocal4m<-data.table::fread(file = "./sensitivity/localsensitivity_4mdepth_alpseeschongau_all_corrMort.csv")
senslocal4m$depth<-4
...
save(morrisOut, file = here::here("sensitivity/morris_screen_1stdepths_alpsee.Rdata"), compress = "gzip")
#load("./sensitivity/morris_sens_2nddepths_abtsdorfer.Rdata")
