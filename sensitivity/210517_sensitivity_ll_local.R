# Local sensitivity work flow for CHARISMA

## General configurations
setting = "local" # "HPC"
species = "species_3" #Adapt in general config file
lakeSel = c(1:3) #Adapt in general config file
parSel = c(9) # Set parameters that are selected: max c(1:28); test: c(3,4,5,6,9,15,27)
...
data.table::fwrite(sens_local, file = paste0("./sensitivity/output/localsensitivity_ll_",steps,"steps.csv"))
